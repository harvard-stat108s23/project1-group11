...
knitr::include_graphics("Cambridge_House.jpeg")
```


```{r}
actionButton("show_popup1", "Spatial distribution", style = "position: absolute; top: 60%; left: 20%;")
actionButton("show_popup2", "Statistical analysis", style = "position: absolute; top: 60%; left: 40%;")
actionButton("show_popup3", "About", style = "position: absolute; top: 60%; left: 60%;")

observeEvent(input$show_popup1, {
  showModal(modalDialog(
    title = "Spatial distribution",
    p("Through this section, you can explore the spatial distributin of the short term rentals with some input of your choice."),
...
observeEvent(input$show_popup2, {
  showModal(modalDialog(
    ...
    p("Through this section, you can have a boxplot analysis of the short term rentals with some input of your choice."),
    footer = modalButton("Close")
  ))
})
...
observeEvent(input$show_popup3, {
  showModal(modalDialog(
    title = "About",
    p("Here you can learn more about the definitions of the variables and data source."),
    footer = modalButton("Close")
  ))
})
```
