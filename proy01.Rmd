...
**Short-term rentals in Cambridge**


```{r include_image, echo=FALSE}

knitr::include_graphics("LEFT-HOUSE.png")
```

**This data dashboard seeks to explore short term rentals in Cambridge, MA. **

**Feel free to navigate to Spatial distribution and Statistical analysis to learn more. **

**You can also learn more about the data source through About.**
